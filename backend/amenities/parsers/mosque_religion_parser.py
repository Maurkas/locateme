...
async def run_mosque_religion_parser(log, stop_flag):
    ...
    async with async_playwright() as p:
        ...
        # Открыть страницу
        url = "https://2gis.ru/astrakhan/search/%D0%BC%D0%B5%D1%87%D0%B5%D1%82%D0%B8?m=48.101763%2C46.348924%2F11.76"
        await page.goto(url)
