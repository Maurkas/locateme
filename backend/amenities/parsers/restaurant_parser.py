...
def save_to_database(name, address, lat, lon):
    ...
    try:
        ...
        Amenities.objects.update_or_create(
            ...
            address=address,
            defaults={
                'type': 'restaurant',  # Указываем тип удобства
...
async def run_restaurant_parser(log, stop_flag):
    ...
    async with async_playwright() as p:
        ...
        # Открыть страницу
        url = "https://2gis.ru/astrakhan/search/%D0%A0%D0%B5%D1%81%D1%82%D0%BE%D1%80%D0%B0%D0%BD%D1%8B/rubricId/164/page/2?m=48.182776%2C46.359079%2F10.87"
        await page.goto(url)
