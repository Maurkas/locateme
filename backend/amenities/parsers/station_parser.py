...
def save_to_database(name, address, lat, lon):
    ...
    try:
        ...
        Amenities.objects.update_or_create(
            ...
            address=address,
            defaults={
                'type': 'station',  # Указываем тип удобства
...
async def run_station_parser(log, stop_flag):
    ...
    async with async_playwright() as p:
        ...
        # Открыть страницу
        url = "https://2gis.ru/astrakhan/search/%D0%90%D0%B2%D1%82%D0%BE%D0%B1%D1%83%D1%81%D0%BD%D1%8B%D0%B5%20%D0%BE%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B8?m=48.053789%2C46.352817%2F11.62"
        await page.goto(url)
