...
def save_to_database(name, address, lat, lon):
    ...
    try:
        ...
        Amenities.objects.update_or_create(
            ...
            address=address,
            defaults={
                'type': 'bank',  # Указываем тип удобства
...
async def run_bank_parser(log, stop_flag):
    ...
    async with async_playwright() as p:
        ...
        # Открыть страницу
        url = "https://2gis.ru/astrakhan/search/%D0%91%D0%B0%D0%BD%D0%BA%D0%BE%D0%BC%D0%B0%D1%82%D1%8B/rubricId/522?m=48.140766%2C46.350422%2F11.6"
        await page.goto(url)
